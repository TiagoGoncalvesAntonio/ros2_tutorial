...
# The first lines import required packages. First we import the TransformStamped 
# from the geometry_msgs, which provides us a template for the message that we will 
...
# static transforms easy. To use the StaticTransformBroadcaster, we need to import it 
# from the tf2_ros module.
...
class StaticFramePublisher(Node):
    ...
    def __init__(self, transformation):
        ...
        # Then, StaticTransformBroadcaster is created, which will send one 
        # static transformation upon the startup.
    ...
    def make_transforms(self, transformation):
        ...
        # send over once populated. Before passing the actual transform values we need to 
        # give it the appropriate metadata.
        # 1 - We need to give the transform being published a timestamp and we’ll just stamp 
        #     it with the current time, self.get_clock().now() 
